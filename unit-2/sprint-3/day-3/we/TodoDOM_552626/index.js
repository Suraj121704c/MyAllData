...
let todoArr = JSON.parse(localStorage.getItem("todo")) || []; //to avoid data loss in the local storage with the refresh
...
//invoke to display local storage data on the web page 
displayTable(todoArr)
